<script lang="ts">
	// typst heading picker: same trigger/panel styling as the md/tex dropdowns, with `=` marker
	// hints instead of `#`. Labels reuse the dialect-neutral Paragraph / Heading N strings.
...
>
	<Popover.Trigger
		class="text-surface-800-200 hover:bg-surface-200-800 flex h-7 items-center gap-1 rounded px-2 text-sm font-medium transition-colors"
	>
