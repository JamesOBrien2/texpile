...
function basicLayout(): VirtualKeyboardLayout {
	return {
...
function calculusLayout(): VirtualKeyboardLayout {
	return {
...
function algebraLayout(): VirtualKeyboardLayout {
	return {
...
function symbolsLayout(): VirtualKeyboardLayout {
	return {
...
function trigLayout(): VirtualKeyboardLayout {
	return {
